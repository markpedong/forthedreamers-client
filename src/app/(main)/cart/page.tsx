...
const Page = () => {
  ...
  return (
    <div className={roboto.className}>
      ...
      <PageTitle title="You may also like" className="!mt-14 !text-center !capitalize" medium />
      <div className="mb-10 text-center">Describe your featured collection here</div>
      ...
      <PageTitle title="Recently viewed products" className="!mt-14 !text-center !capitalize" medium />
      <div className="mb-10 text-center"> Describe your recently viewed products here</div>
      <div className={styles.suggestionsContainer}>
        <Product />
        <Product />
        <Product />
