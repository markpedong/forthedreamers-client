...
export const TERMS_ARRAY = [
	...
	'1.6 You must not use another person’s Account without our, and/or the other person’s express permission. If you suspect or become aware of any unauthorized use of your Account or that your password is no longer secure, please contact us (Instagram: @forthedreamers) immediately and take immediate steps to re-secure your Account (including by changing your password).',
...
export const SITE_INFORMATION_TERMS = [
	'2.1 The Site and the content on the Site are subject to copyright, trademarks and other intellectual property rights. These rights are owned by or licensed to FOR THE DREAMERS.',
...
export const ORDER_AND_CONTRACT_TERMS = [
	...
	'3.5 If you discover that you have made a mistake with your Order after you have submitted it to the Site, please contact us (Instagram: @forthedreamers) immediately, although please note we cannot guarantee that we will be able to amend your Order in accordance with your instructions and that fees may be applicable to process a change.',
...
export const DELIVERY_TERMS = [
	...
	'4.6 You must take care when opening the product so as not to damage it, particularly when using any sharp instruments.'
]
...
export const CANCELLATION_TERMS = [
	...
	'5.2 If you wish to cancel your Order, please contact us (Instagram: @forthedreamers). Once an Order has been shipped, it cannot be cancelled and the item must instead be returned to us in accordance with the returns policy.'
]

export const FAULTY_PRODUCT_RETURNS_TERMS = [
	'6.1 We aim to provide you with products of the highest standard and quality. If you have received a product with a defect, please contact us (Instagram: @forthedreamers) as soon as possible so we can guide you through the returns process and help resolve the problem as swiftly as possible. In order to assist the return process, you may be required to send us images of the damage, defect or fault for preliminary assessment. You may be asked to provide further information to support your claim to assist us with our assessment of the goods.',
...
export const CHANGE_OF_MIND_RETURNS_TERMS = [
	'(a) as long as the return is initiated in your Account and the return is placed in the post within 14 days of receipt of order confirmation email (or longer promotional return period, if applicable);',
...
export const GIFT_CARDS_TERMS = [
	...
	'(c) The credit of a gift card does not accrue interest nor can it be redeemed or refunded for cash at any time. Gift cards cannot be used to buy further gift cards. To use a gift card, please follow the Gift Card Manual for use.',
	'(d) If you place an Order less than the value of the gift card, the residual credit cannot be redeemed for cash. If the gift card is insufficient for the Order you wish to make, you may make up the difference through payment by other means.',
	'8.3 If you cancel or return items purchased using a gift card, we will ge',
...
export const USER_GENERATED_CONTENT_TERMS = [
	...
	'(d) FOR THE DREAMERS may enhance, adapt, crop or otherwise modify your Content. Any such modifications would only occur to the extent deemed reasonably appropriate by us; and',
	'(e) You are solely responsible for your Content and will not seek to hold FOR THE DREAMERS liable for any demands by a third party related to our use of your Content.',
	'9.3 You may revoke your permission for us to use your Content at any time by sending a request to (Instagram: @forthedreamers). Upon receiving such a request, we agree to remove your Content from our online platforms as soon as reasonably practicable, and removed to the extent technically practicable.',
...
export const DISCLAIMER_AND_LIABILITY_TERMS = [
...
export const PRIVACY_POLICY_TERMS = [
...
export const GENERAL_TERMS = [
	...
	'14.6 Third party rights: All provisions of these Terms apply equally to and are for the benefit of FOR THE DREAMERS, its content providers and each shall have the right to assert and enforce such provisions directly or on its own behalf (save that these Terms may be varied or rescinded without the consent of those parties).',
...
export const DEFINITIONS_AND_INTERPRETATION_TERMS = [
	'15.1 Definitions',
	...
	'“FOR THE DREAMERS”, "we", "our", "us"means FOR THE DREAMERS and its representatives, employees, partners, and independent contractors.',
	'15.2  Interpretation',
	...
	'',
	'These Terms were last updated on 30th April 2024'
]
