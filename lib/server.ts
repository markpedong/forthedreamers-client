...
export const getWebsiteData = async () =>
  (await get<TWebsiteItem>({ url: '/public/website', tags: API_TAGS.WEBSITE }))?.data

// /public/collectionsByID
export const getCollectionsByID = async params =>
  (await get<TCollectionDetails>({ url: '/public/collectionsByID', data: params, tags: API_TAGS.COLLECTIONS_BY_ID }))
    ?.data

// /public/testimonials
export const getTestimonials = async () =>
  (await get<TTestimonials[]>({ url: '/public/testimonials', tags: API_TAGS.TESTIMONIALS }))?.data
